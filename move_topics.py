...
for i in range(1, 10):
    ...
    <div class="schedule-day-panel" id="day-{i}"{display}>
      <div class="schedule-day-title">
        <h3>Day {i}</h3>
        <p>Divine Discourse by Raseshwari Devi Ji</p>
      </div>
      <div class="schedule-timeline">
        ...
        <div class="timeline-item" style="animation-delay:0.1s"><div class="timeline-time">06:45 PM</div><div class="timeline-dot"></div><div class="timeline-content"><div class="timeline-content-inner"><h4>Shrimad Bhagwat Mahapuran Pravachan</h4><p>{theme}</p></div></div></div>
